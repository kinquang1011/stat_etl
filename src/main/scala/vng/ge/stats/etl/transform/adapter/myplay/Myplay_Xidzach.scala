...
/**
  ...
  */
class Myplay_Xidzach extends  MyplayFormatter ("myplay_xidzach"){
  ...
  override def getActivityDs(logDate: String, hourly: String): DataFrame = {
    ...
    if(hourly == ""){
      val logPatternPath = Constants.WAREHOUSE_DIR +"/xidzach/unknown_log/[yyyy-MM-dd]/*"
