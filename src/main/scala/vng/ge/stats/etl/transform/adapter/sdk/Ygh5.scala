...
/**
  ...
  */
class Ygh5 extends SdkFormatter ("ygh5") {
  ...
  override def getIdRegisterDs(logDate: String, _activityDs: DataFrame, _totalAccLoginDs: DataFrame): DataFrame = {
    ...
    val patternlLoginRegister = Constants.GAMELOG_DIR + "/ygh5/[yyyyMMdd]/login_log/vn/app_users.txt"



//    val patternlLoginRegister = Constants.GAMELOG_DIR + "/ygh5/login_log/full/vn/app_users.txt"
  ...
  override def getActivityDs(logDate: String, hourly: String): DataFrame = {
    ...
    if (hourly == "") {
      val logPattern = Constants.GAME_LOG_DIR + "/ygh5/[yyyyMMdd]/login_log/vn/log_user_login.txt"
//      val logPattern = Constants.GAME_LOG_DIR + "/ygh5/login_log/full/vn/log_user_login.txt"
...
//    val patternlLoginRegister = Constants.GAMELOG_DIR + "/ygh5/login_log/full/vn/app_users.txt"
  ...
  override def getPaymentDs(logDate: String, hourly: String): DataFrame = {
    ...
    if (hourly == "") {
      val logPattern = Constants.GAME_LOG_DIR + "/sdk/[yyyy-MM-dd]/Log_YUGIOH5_DBGAdd/" + "Log_YUGIOH5_DBGAdd-[yyyy-MM-dd].gz"
...
//      payment = getJsonLog(logPath)
    ...
    if (payment.rdd.isEmpty()) {
      ...
      payment = payment.withColumn(sf.GAME_CODE, lit("ygh5"))
